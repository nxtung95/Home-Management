...
public interface UserRepository extends CrudRepository<User, Integer> {
    ...
    @Query("SELECT new com.tungnx.home.dto.AuthenticationLoginUserDto(u.id, u.username, u.password, r.name) FROM User u JOIN u.roles r WHERE u.username = :username")
